...
def build_face_feature_projector(config):
    ...
    if projector_type == 'linear':
        return nn.Linear(config, config.face_feature_hidden_size, config.hidden_size)
...
def build_landmark_feature_projector(config):
    ...
    if projector_type == 'linear':
        return nn.Linear(config, config.landmark_feature_hidden_size, config.hidden_size)
