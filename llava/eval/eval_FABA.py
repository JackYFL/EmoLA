...
def get_args():
    ...
    parser.add_argument("--model-path", type=str, default="/home/liyifa11/MyCodes/EmoDQ/EmoDQ/saved_checkpoints/llava-v1.5-7b-finetune-emotiongpt")
    ...
    parser.add_argument("--ann-file", type=str, default='/home/liyifa11/MyCodes/EmoDQ/EmotionInstructData/gpt4_annotated/emotion_test.json')
    parser.add_argument("--data-dir", type=str, default='/home/liyifa11/MyCodes/EmoDQ/EmotionInstructData/gpt4_annotated/test_imgs')
...
def eval():
    ...
    for img_id, img in tqdm.tqdm(enumerate(annos), desc="Processing images", unit="img_id"):
            ...
            try:
                ...
                pass
            # bleu = cal_bleu(gpt_output, emotion_description)
    ...
    if args.task_type == 'emotion':
        ...
        if 'GFT' in args.ann_file:
            ...
            # select_AUs = ['1', '2', '4', '5', '6', '7', '9', '10', '12', '14', '15', '16', '17', '20', '23', '24', '25', '26', '27', '43']
